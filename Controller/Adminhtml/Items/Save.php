...
class Save extends \Risecommerce\TeamMember\Controller\Adminhtml\Items
{
            ...
            try {
                ...
                if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                    try{
                        ...
                        $destinationPath = $mediaDirectory->getAbsolutePath('risecommerce/teammember');
                        ...
                        $imagePath = 'risecommerce/teammember'.$result['file'];
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('risecommerce_teammember/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('risecommerce_teammember/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('risecommerce_teammember/*/new');
                }
                return;
            } catch (\Exception $e) {
